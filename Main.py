...
def Q3a():
    return Configuration().add(
            Wall({'position': [0, 0, 0], 'width':7, 'height':2.6, 'edges': True, 'orientation':45})
            )
def Q4a():
    ...
    wall4 = Wall({'position': [-7, -7, 0], 'width':7, 'height':2.6, 'edges': True, 'orientation':90})  
    house = House({'position': [0, 0, 0], 'orientation':45})
